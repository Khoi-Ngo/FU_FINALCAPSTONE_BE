...
public class UserController : BaseController
{
   ...
   , IBackgroundTaskQueue taskQueue) : base(endpointSettings)
    ...
    /// <summary>
    /// Retrieves paginated STUDENT users from the system with search functionality.
    /// </summary>
    ...
    [PermissionAuthorize((int)EUserRole.ADMIN)]
    [AuditLog(Tag = "VIEW_USER")]
    public async Task<IActionResult> GetAllStudentsPaged([FromQuery] GetUsersWithSearchRequest request)
    {
    ...
    /// <summary>
    /// Retrieves paginated academic staff users from the system with search functionality.
    /// </summary>
    /// <param name="request">Pagination and search parameters</param>
    /// <returns>Paginated list of academic staff</returns>
    [HttpGet("academic-staffs/paged")]
    [PermissionAuthorize((int)EUserRole.ADMIN)]
    [AuditLog(Tag = "VIEW_USER")]
    public async Task<IActionResult> GetAllAcademicStaffsPaged([FromQuery] GetUsersWithSearchRequest request)
    {
    ...
    /// <summary>
    /// Retrieves paginated admin users from the system with search functionality.
    /// </summary>
    /// <param name="request">Pagination and search parameters</param>
    ...
    [PermissionAuthorize((int)EUserRole.ADMIN)]
    [AuditLog(Tag = "VIEW_USER")]
    public async Task<IActionResult> GetAllAdminsPaged([FromQuery] GetUsersWithSearchRequest request)
    {
    ...
    /// <summary>
    /// Retrieves paginated manager users from the system with search functionality.
    /// </summary>
    /// <param name="request">Pagination and search parameters</param>
    /// <returns>Paginated list of manager users</returns>
    [HttpGet("managers/paged")]
    [PermissionAuthorize((int)EUserRole.ADMIN)]
    [AuditLog(Tag = "VIEW_USER")]
    public async Task<IActionResult> GetAllManagersPaged([FromQuery] GetUsersWithSearchRequest request)
    {
    ...
    /// <summary>
    /// Retrieves paginated advisor users from the system with search functionality.
    /// </summary>
    /// <param name="request">Pagination and search parameters</param>
    /// <returns>Paginated list of advisor users</returns>
    [HttpGet("advisors/paged")]
    [PermissionAuthorize((int)EUserRole.ADMIN)]
    [AuditLog(Tag = "VIEW_USER")]
    public async Task<IActionResult> GetAllAdvisorsPaged([FromQuery] GetUsersWithSearchRequest request)
    {
    ...
    /// <summary>
    /// Retrieves all active Advisors from the system with search functionality. (Support Booking Feature ~ Student Access only)
    /// </summary>
    /// <param name="request">Pagination and search parameters</param>
    /// <returns>Paginated list of active advisors</returns>
    [HttpGet("advisors/active/paged")]
    [PermissionAuthorize((int)EUserRole.STUDENT)]
    public async Task<IActionResult> GetAllActiveAdvisors([FromQuery] GetUsersWithSearchRequest request)
    {
