...
{
    /// <inheritdoc />
    public partial class ReduceTheMaxNumberOfBanCheckOnTBLMeeting01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create updated trigger with ban limit changed to 10
            migrationBuilder.Sql(@"
            ...
            migrationBuilder.Sql(@"
                EXEC sp_addextendedproperty 
                    ...
                    @value = N'Trigger to check student ban limit (10), leave schedule conflicts, and exact booking availability match for BookedMeeting.', 
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Revert to original trigger with ban limit of 30
            migrationBuilder.Sql(@"
                CREATE TRIGGER TR_BookedMeeting_CheckExternalTables
                ON BookedMeeting
                AFTER INSERT, UPDATE
