...
{
    /// <inheritdoc />
    public partial class ExactToMostlyCheckBookingAvaiInMeeting : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create updated trigger with corrected DayInWeek comparison
            migrationBuilder.Sql(@"
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Revert to previous trigger with original DayInWeek comparison
            migrationBuilder.Sql(@"
                CREATE TRIGGER TR_BookedMeeting_CheckExternalTables
                ON BookedMeeting
                AFTER INSERT, UPDATE
            ...
            migrationBuilder.Sql(@"
                EXEC sp_addextendedproperty 
                    @name = N'MS_Description', 
                    @value = N'Trigger to check student ban limit (10), leave schedule conflicts, and whether meeting time falls within booking availability for BookedMeeting.', 
                    @level0type = N'SCHEMA', @level0name = N'dbo', 
                    @level1type = N'TABLE', @level1name = N'BookedMeeting', 
                    @level2type = N'TRIGGER', @level2name = N'TR_BookedMeeting_CheckExternalTables';
            ");
