...
public class AuditLogFilter : IAsyncActionFilter
{
    ...
    public AuditLogFilter(IBackgroundTaskQueue taskQueue, IJWTService jWTService, EndpointSettings endpointSettings, ILogger<AuditLogFilter> logger)
    {
    ...
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        {
            _logger.LogError(e, "Exception in audit filter");
        }
    }
